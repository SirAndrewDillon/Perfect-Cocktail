...
const About = () => (
  <div css={aboutStyles} data-testid="about">
    <h1>
      About <em>Perfect Cocktail</em>
    </h1>
    <p>My name is Andrew and I am a web developer based out of Indianapolis.</p>
    <p>
    ...
    >
      ...
      ></img>
      <a
        href="https://www.github.com/sirandrewdillon"
    ...
    >
      ...
      ></img>
      <a
        href="https://www.linkedin.com/in/pandrewdillon/"
        rel="noopener noreferrer"
        target="_blank"
        css={css`
          text-decoration: none;
